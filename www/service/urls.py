...
urlpatterns = patterns('www.service.views',
    ...
    url(r'^zgloszenie/podglad_wydruku/(?P<product_id>\d+)/$', login_required('html_pdf_preview'), name='product-print-preview'),
    url(r'^zgloszenie/drukuj/(?P<product_id>\d+)/$', login_required('get_pdf'), name='product-print'),
