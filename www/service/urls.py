...
from www.service.views import ProductListView, ProductAddView, \
                    ProductDetailView, ClientEditView, ClientListView, \
                    ClientAddView, ClientDetailView, ReportView, \
                    CommentAddView, html_pdf_preview, get_pdf
...
urlpatterns = patterns('www.service.views',
    ...
    url(r'^komentarz/(?P<product_id>\d+)/$', login_required(CommentAddView.as_view()), name='comment-add'),
