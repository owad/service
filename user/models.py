...
class User(DjangoUser):
    ...
    role = models.IntegerField(blank=True, null=True, default=3, choices=[(EMPLOYEE, 'Serwisant'), (CLIENT_WITH_ACCESS, 'Klient z dostępem do zleceń'), (CLIENT, 'Zwykły klient')], verbose_name="Typ")
    ...
    def save(self):
        self.set_password(DjangoUser.objects.make_random_password())
        self.is_active = False if self.role == CLIENT else True
        self.is_staff = False
